...
webElem <- remDr$findElement(
  using = "css",
     '#app > div.app-container > div > div > div > div.col-6 > div > div > div > form > div:nth-child(1) > div > div > div > div > input'
#    '#app > div.app-container > div > div > div > div.login.col-6 > div > div > div > form > div:nth-child(1) > div > div > div > div > input'
)
#app > div.app-container > div > div > div > div.col-6
...
url_strings_list <- remDr$executeScript(
  ...
  select(name) %>%
  filter_all(all_vars(grepl('https://seller.shopee.co.id/webchat/api/', .)))

View(url_strings_list)
#https://seller.shopee.co.id/webchat/api/
for (u_string in url_strings_list) {
POST(
  url = url_strings_list[u_string],
  add_headers(
