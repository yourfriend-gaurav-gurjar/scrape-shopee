...
#     user_agent()
     set_cookies(... = list(c(
                      ...
                      after_cookies$name[7],
                      after_cookies$name[9],
                      after_cookies$name[12]),
                  .cookies = list(c(
                    after_cookies$value[1],
                    after_cookies$value[2],
                    after_cookies$value[3],
                    after_cookies$value[4],
                    after_cookies$value[5],
                    after_cookies$value[6]),
                    after_cookies$value[7],
                    after_cookies$value[9],
